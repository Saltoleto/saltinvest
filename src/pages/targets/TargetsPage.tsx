    ...
    <div className="grid gap-4 lg:gap-6">
      <Card className="p-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="grid grid-cols-[1fr_auto] items-center gap-3 sm:flex sm:items-center sm:justify-end">
            <div className="rounded-xl2 border border-slate-200 bg-slate-50 px-3 py-2">
              <div className="text-[11px] text-slate-600 leading-none">Total</div>
              <div className="mt-1 text-2xl font-semibold text-slate-900 leading-none">{total.toFixed(1)}%</div>
            </div>
        ...
        <div className="mt-4 rounded-xl2 border border-slate-200 bg-slate-50 p-3">
          <div className="text-xs text-slate-600">Progresso do total configurado</div>
          <div className="mt-2 scale-y-125 origin-center"><Progress value={(totalClamped / 100) * 100} /></div>
        ...
        {classes.loading ? (
            ...
            {Array.from({ length: 2 }).map((_, i) => (
              <div key={i} className="rounded-xl2 border border-slate-200 bg-white p-4">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="grid grid-cols-[40px_auto_40px] items-center gap-2 self-start sm:self-auto">
          ...
          <div className="grid gap-3">
            {(classes.data ?? []).map((c) => {
              ...
              return (
                <div key={c.id} className="rounded-xl2 border border-slate-200 bg-white p-4">
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div className="min-w-0">
                    ...
                    <div className="grid grid-cols-[40px_auto_40px] items-center gap-2 self-start sm:self-auto">
                      <button
                        type="button"
                        className="h-9 w-9 rounded-full border border-slate-200 bg-white text-slate-900 hover:bg-slate-100"
                      ...
                      <div className="min-w-[86px] rounded-xl2 border border-slate-200 bg-slate-50 px-2 py-1 flex flex-col items-center justify-center">
