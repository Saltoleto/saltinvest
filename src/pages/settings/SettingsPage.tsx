  ...
  return (
    <div className="grid gap-4 lg:gap-6">
      ...
      <Card className="p-4 lg:hidden">
        <div className="text-slate-900 font-semibold">Conta</div>
        <div className="mt-1 text-sm text-slate-600">Gerencie sua sessão com segurança.</div>

        <div className="mt-4 rounded-xl2 border border-slate-200 bg-white px-4 py-3">
          <div className="text-xs text-slate-600">Logado como</div>
          <div className="mt-1 text-sm text-slate-800 truncate">{user?.email ?? "—"}</div>
        </div>
